<div class="d-flex justify-content-center align-items-center vh-100">
    <form class="d-flex flex-column col-10 col-md-3">
        <div class="form-floating mb-3">
            ...
            <div id="validationServerEmailAddress" class="invalid-feedback"></div>
        </div>
        <div class="form-floating">
            <input type="password" class="form-control" id="password" placeholder="Password">
            <label for="password">Password</label>
            <div id="validationServerPassword" class="invalid-feedback"></div>
        </div>
        
        <button type="submit" id="signInAction" class="btn btn-primary mt-3">Sign In</button>
